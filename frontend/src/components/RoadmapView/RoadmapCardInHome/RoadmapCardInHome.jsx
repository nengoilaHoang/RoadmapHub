...
const RoadmapCard = ({
  ...
  // Portal overlay
  const overlayPortal = hovered && cardRect && ReactDOM.createPortal(
    <div
    ...
    >
      <div className="overlay-content">
        <div className="overlay-header">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24"
                 ...
                 strokeWidth="2"
            >
              <polygon points="12,2 15.09,8.26 22,9 17,14.74 
        ...
        <div className="overlay-row">
          <svg className="overlay-icon" viewBox="0 0 24 24" fill="none" stroke="#6366f1" strokeWidth="2">
            <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4
                     -4 1.79-4 4 1.79 4 4 4z" />
            <path d="M6 20v-1c0-2.76 2.24-5 5-5h2
        ...
        <div className="overlay-row">
          <svg className="overlay-icon learning-icon" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2">
            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>
            <circle cx="9" cy="7" r="4"/>
            <path d="m22 21-3-3m0 0a2 2 0 0 0 0-4
                     a2 2 0 0 0 0 4"/>
          </svg>
        ...
        <div className="overlay-row">
          <svg className="overlay-icon teaching-icon" viewBox="0 0 24 24" fill="none" stroke="#6366f1" strokeWidth="2">
    ...
    <>
      ...
      >
        ...
        <div className="card-author">
          <svg className="author-icon" viewBox="0 0 24 24" fill="none" stroke="#6366f1" strokeWidth="2">
